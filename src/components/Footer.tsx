...
import { FADE_UP, STAGGER_CONTAINER, EASE_OUT_EXPO } from "@/lib/motion";
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <motion.div variants={FADE_UP} className="md:col-span-1">
            <div className="mb-4">
              <p className="text-brand-gold text-[10px] tracking-[0.25em] uppercase">Eetcafe</p>
            ...
            <p className="font-body text-sm leading-relaxed" style={{ color: "rgba(201,180,138,0.5)" }}>
              Eetcafe in Kralingen.
              <br />
              Geen gedoe, gewoon lekker.
            </p>
            ...
            <motion.a
              ...
              className="inline-flex items-center gap-2 mt-5 label-caps text-[11px]"
              style={{ color: "rgba(196,144,46,0.55)" }}
              aria-label="Volg ons op Instagram (opent in nieuw tabblad)"
              whileHover={{ x: 3, color: "#C4902E" }}
          ...
          <motion.div variants={FADE_UP}>
            <p className="label-caps text-[11px] mb-5" style={{ color: "rgba(196,144,46,0.45)" }}>
              Navigatie
            </p>
        ...
        >
          <p className="label-caps text-[10px]" style={{ color: "rgba(201,180,138,0.2)" }}>
            {"©"} {year} Cafe De Kloeg {"·"} Libanonweg 18, 3061 KJ Rotterdam
          </p>
